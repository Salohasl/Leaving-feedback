...
const EMAIL_SETTINGS = [
  'addresses' => ['valeriazavidy@yandex.ru'], // кому необходимо отправить письмо
  'from' => ['valeriazavidy@yandex.ru', 'Site'], // от какого email и имени необходимо отправить письмо
  'subject' => 'Сообщение с формы обратной связи', // тема письма
  'host' => 'ssl://smtp.yandex.ru', // SMTP-хост
  'username' => 'valeriazavidy@yandex.ru', // // SMTP-пользователь
  'password' => 'whhozmeixxxkplmv', // SMTP-пароль
  'port' => '465' // SMTP-порт
];
